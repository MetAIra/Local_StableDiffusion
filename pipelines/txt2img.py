...
def generate_images(
    ...
    pipeline, lora_error = get_pipeline_checked(
        "txt2img", vae_name, model_name, scheduler_name,
    ...
    output_dir = create_output_dir(base_path, "txt2img", prompt)
    ...
    for i in range(int(num_images)):
        ...
        filename = f"image_{i+1:03d}_seed{seed}{suffix}.png"
        ...
        print(f"Generated {i+1}/{int(num_images)}: seed={seed}")
    ...
    return generated_images, f"{num_images}枚の画像を生成しました{face_restore_info}\n保存先: {output_dir}"
